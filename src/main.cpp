...
int main()
{
    ...
    GLFWwindow* window;
    window = glfwCreateWindow(800, 800, "INF01047 - 00265830 - RAFAEL JUNIOR RIBEIRO", NULL, NULL);
    if (!window)
    {
        glfwTerminate();
    ...
    ObjModel carro("../../data/carro.obj");
    ComputeNormals(&carro);
    BuildTrianglesAndAddToVirtualScene(&carro);
